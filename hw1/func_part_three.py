...
def q_learning_double(env, A, Q, episodes=100_000, alpha=0.009, epsilon=0.85, gamma=1):
...
def evaluate_pi(env, pi, n=100_000):
    rewards = []
    for _ in (range(n)):
...
def plot_q_learinig_double(env, A, alpha, epsilon, episodes=1000, n_experiments=50, n_eval=100):
